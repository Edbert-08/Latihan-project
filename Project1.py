...
frame_tombol.pack()
ttk.Button(frame_tombol, text="Lihat Data", command=buka_halaman2).grid(row=0, column=0, padx=5)
ttk.Button(frame_tombol, text="Cari Data", command=buka_halaman3).grid(row=0, column=1, padx=5)
...
ttk.Button(halaman2, text="Kembali", command=kembali_ke_halaman1).pack(pady=10)
...
ttk.Button(halaman3, text="Kembali", command=kembali_ke_halaman1).pack(pady=10)
